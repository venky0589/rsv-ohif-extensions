...
import { RPanelStudyBrowserHeader } from './RPanelStudyBrowserHeader';
import { RStudyBrowser } from './RStudyBrowser';
...
const RPanelStudyBrowser = ({ commandsManager, dataSource, extensionManager, servicesManager, getStudiesForPatientByMRN, requestDisplaySetCreationForStudy, getImageSrc, keyTimePoints = [] }) => {
    const navigate = useNavigate();

    const { hangingProtocolService, displaySetService, uiNotificationService, customizationService } = servicesManager.services;
    ...
    return (
        <>
            <>
                <h2>Panel Study Browser Header</h2>
                <RPanelStudyBrowserHeader
...
export default RPanelStudyBrowser;
